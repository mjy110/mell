package com.example.firsttest.httplibrary.httplibrary.client;

import android.text.TextUtils;
import android.util.Log;


import com.example.firsttest.httplibrary.httplibrary.callback.BaseCallBack;
import com.example.firsttest.httplibrary.httplibrary.conifg.GlobalConfig;
import com.example.firsttest.httplibrary.httplibrary.manager.RetrofitManager;
import com.example.firsttest.httplibrary.httplibrary.server.HttpServer;
...
public class HttpClient {
    ...
    private Observable createObservable() {
        ...
        this.baseUrl = this.baseUrl!=null?this.baseUrl: GlobalConfig.getInstance()
                .getBaseUrl();
